...
namespace DSIGE.Dato
{
    public class Cls_Dato_Importacion_Lecturas
    {
        ...
        public object Capa_Dato_save_CargaProgramacion(string fechaEnvioMovil, int idServicio, int idOpcion, int usuario)
        {
            resul res = new resul();
            try
            {
                ...
                {
                    con.Open();
                    using (SqlCommand cmd = new SqlCommand("SP_I_CARGA_PROGRAMACION_GRABAR", con))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public object Capa_Dato_save_MacroOrdenes(string fechaEnvioMovil, int idServicio, int idOpcion, int usuario)
        {
            resul res = new resul();
            try
            {
                ...
                {
                    con.Open();
                    using (SqlCommand cmd = new SqlCommand("SP_I_MACRO_ORDENES_GRABAR", con))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@fechaEnvioMovil", SqlDbType.VarChar).Value = fechaEnvioMovil;
        ...
        public object Capa_Dato_save_MacroOperaciones(string fechaEnvioMovil, int idServicio, int idOpcion, int usuario)
        {
            resul res = new resul();
            try
            {
                ...
                {
                    con.Open();
                    using (SqlCommand cmd = new SqlCommand("SP_I_MACRO_OPERACIONES_GRABAR", con))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@fechaEnvioMovil", SqlDbType.VarChar).Value = fechaEnvioMovil;
        ...
        public object Capa_Dato_save_temporalImportarLds(string fileLocation, int usuario, string nombreArchivo)
        {
            resul res = new resul();
            ...
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(cadenaCnx))
                {
                    ...
                    //eliminando registros del usuario
                    using (SqlCommand cmd = new SqlCommand("SP_D_TEMPORAL_IMPORTACION_LDS", con))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@idUsuario", SqlDbType.Int).Value = usuario;
                    ...
                    using (SqlBulkCopy bulkCopy = new SqlBulkCopy(con))
                    {
                        bulkCopy.BatchSize = 500;
                        bulkCopy.NotifyAfter = 1000;
                        bulkCopy.DestinationTableName = "TEMPORAL_IMPORTACION_LDS";
                        bulkCopy.WriteToServer(dt);

                        //Actualizando campos 

                        string Sql = "UPDATE TEMPORAL_IMPORTACION_LDS SET nombreArchivo='" + nombreArchivo + "',  idUsuarioImportacion='" + usuario + "', fechaImportacion=getdate()   WHERE idUsuarioImportacion IS NULL    ";
                    ...
                    using (SqlCommand cmd = new SqlCommand("SP_S_TEMPORAL_IMPORTACION_LDS_AGRUPADO", con))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@idUsuario", SqlDbType.Int).Value = usuario;
        ...
        public object Capa_Dato_save_importacionLds(string fechaRecepcion, string fechaInicio, string fechaTermino, int usuario, int tipoReparto, int anio, int mes)
        {
            resul res = new resul();
            try
            {
                using (SqlConnection con = new SqlConnection(cadenaCnx))
                {
                    ...
                    try
                    {
                        using (SqlCommand cmd = new SqlCommand("SP_I_IMPORTAR_EXCEL_GRABAR", con, sqlTran))
                        {
                            cmd.CommandTimeout = 0;
                            cmd.CommandType = CommandType.StoredProcedure;
                            cmd.Parameters.Add("@fechaRecepcion", SqlDbType.VarChar).Value = fechaRecepcion;
                            cmd.Parameters.Add("@fechaInicio", SqlDbType.VarChar).Value = fechaInicio;
                            cmd.Parameters.Add("@fechaTermino", SqlDbType.VarChar).Value = fechaTermino;
                            cmd.Parameters.Add("@idUsuario", SqlDbType.Int).Value = usuario;
                            cmd.Parameters.Add("@tipoReparto", SqlDbType.Int).Value = tipoReparto;
