...
namespace DSIGE.Dato
{
    public class Cls_Dato_AsignaOrdenTrabajo
    {
        ...
        public object Capa_Dato_getCargos()
        {
            Resultado res = new Resultado();
            try
            {
                ...
                {
                    con.Open();
                    using (SqlCommand cmd = new SqlCommand("SP_S_ASIGNACION_LDS_COMBO_CARGO", con))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public object Capa_Dato_getEstados()
        {
            Resultado res = new Resultado();
            try
            {
                ...
                {
                    con.Open();
                    using (SqlCommand cmd = new SqlCommand("SP_S_ASIGNACION_LDS_COMBO_ESTADOS", con))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public object Capa_Dato_getSucursales()
        {
            Resultado res = new Resultado();
            try
            {
                ...
                {
                    con.Open();
                    using (SqlCommand cmd = new SqlCommand("SP_S_REPORTE_CONSULTA_REPARTO_COMBO_SUCURSALES", con))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public object Capa_Dato_getOperarios()
        {
            Resultado res = new Resultado();
            try
            {
                ...
                {
                    con.Open();
                    using (SqlCommand cmd = new SqlCommand("SP_S_ASIGNACION_LDS_COMBO_OPERARIOS", con))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public object Capa_Dato_getSupervisores()
        {
            Resultado res = new Resultado();
            try
            {
                ...
                {
                    con.Open();
                    using (SqlCommand cmd = new SqlCommand("SP_S_ASIGNACION_LDS_COMBO_SUPERVISORES", con))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public object Capa_Dato_getRepartos_asignarReasignar(string anio, string mes, int idCargo, int idEstado)
        {
            Resultado res = new Resultado();
            try
            {
                ...
                {
                    con.Open();
                    using (SqlCommand cmd = new SqlCommand("SP_S_ASIGNACION_LDS_CAB", con))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@anio", SqlDbType.Int).Value = anio;
        ...
        public object Capa_Dato_GenerarAsignacionReasignacion(List<Asignar_E> ListaOrdenes, int anio, int mes, int idCargo, int idEstado, string tipo, int usuario, int idTecnico)
        {
            Resultado res = new Resultado();
            try
            {

                PropertyDescriptorCollection properties = TypeDescriptor.GetProperties(typeof(Asignar_E));
                ...
                foreach (Asignar_E item in ListaOrdenes)
                {
                ...
                using (SqlConnection con = new SqlConnection(cadenaCnx))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand("SP_D_TEMPORAL_ASIGNACION_REASIGNACION", con))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                    ...
                    using (SqlBulkCopy bulkCopy = new SqlBulkCopy(con))
                    {
                        ...
                        bulkCopy.DestinationTableName = "TEMPORAL_ASIGNACION_REASIGNACION";
                        bulkCopy.WriteToServer(table);

                        //Actualizando campos 
                        string Sql = "UPDATE TEMPORAL_ASIGNACION_REASIGNACION SET idTecnico='" + idTecnico + "' , fechaCreacion= getdate(),  tipo='" + tipo + "' , usuario='" + usuario + "' WHERE usuario IS NULL";
                        ...
                        using (SqlCommand cmd = new SqlCommand("SP_S_ASIGNACION_LDS_GRABAR_ACTUALIZAR", con))
                        {
                            cmd.CommandTimeout = 0;
                            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public object Capa_Dato_getExportar_Asignacion(string anio, string mes, int idCargo, int idEstado)
        {
            Resultado res = new Resultado();
            try
            {
                using (SqlConnection con = new SqlConnection(cadenaCnx))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand("SP_S_ASIGNACION_LDS_CAB", con))
                    {
                        ...
                        using (SqlDataAdapter da = new SqlDataAdapter(cmd))
                        {
                            ...
                            {
                                res.ok = true;
                                res.data = GenerarExcel_asignacion(dt_detalle);
                            }
                        }
                    }
                }
        ...
        public string GenerarExcel_asignacion(DataTable listDetalle)
        {
            string Res = "";
            string FileRuta = "";
            string FileExcel = "";
            ...
            try
            {
                var guid = Guid.NewGuid();
                var guidB = guid.ToString("B");
                var nombreFile = "Reparto_" + Guid.Parse(guidB) + ".xlsx";
                ...
                using (Excel.ExcelPackage oEx = new Excel.ExcelPackage(_file))
                {
                    ...
                    oWs.Cells[_fila, pos].Value = "TOTAL ZONA"; pos += 1;
                    oWs.Cells[_fila, pos].Value = "TOTAL ORDINARIO"; pos += 1;
                    oWs.Cells[_fila, pos].Value = "TOTAL RECLAMO"; pos += 1;

                    oWs.Cells[_fila, pos].Value = "ID PERSONAL "; pos += 1;
                    oWs.Cells[_fila, pos].Value = "ID SUPERVISOR"; pos += 1;

                    oWs.Cells[_fila, pos].Value = "INICIO REPARTO"; pos += 1;
                    oWs.Cells[_fila, pos].Value = "FIN DE REPARTO"; pos += 1;
                    oWs.Cells[_fila, pos].Value = "F. RECEPCION"; pos += 1;
                    ...
                    foreach (DataRow item in listDetalle.Rows)
                    {
                        ...
                        oWs.Cells[_fila, pos].Value = item["totalZona"].ToString(); pos += 1;
                        oWs.Cells[_fila, pos].Value = item["totalOrdinario"].ToString(); pos += 1;
                        oWs.Cells[_fila, pos].Value = item["totalReclamo"].ToString(); pos += 1;
                        oWs.Cells[_fila, pos].Value = item["id_Operario_Reparto"].ToString(); pos += 1;

                        oWs.Cells[_fila, pos].Value = item["id_Supervisor_Reparto"].ToString(); pos += 1;
                        oWs.Cells[_fila, pos].Value = item["inicioReparto"].ToString(); pos += 1;
                        oWs.Cells[_fila, pos].Value = item["finReparto"].ToString(); pos += 1;
                        oWs.Cells[_fila, pos].Value = item["Frecepcion"].ToString(); pos += 1;
        ...
        public object Capa_Dato_save_temporalImportarAsignacion(string fileLocation, int usuario, string nombreArchivo, int anio, int mes, int idCargo, int idEstado)
        {
            Resultado res = new Resultado();
            ...
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(cadenaCnx))
                {
                    ...
                    //eliminando registros del usuario
                    using (SqlCommand cmd = new SqlCommand("SP_D_TEMPORAL_IMPORTACION_ASIGNACION", con))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@idUsuario", SqlDbType.Int).Value = usuario;
                    ...
                    using (SqlBulkCopy bulkCopy = new SqlBulkCopy(con))
                    {
                        bulkCopy.BatchSize = 500;
                        bulkCopy.NotifyAfter = 1000;
                        bulkCopy.DestinationTableName = "TEMPORAL_IMPORTACION_ASIGNACION";
                        bulkCopy.WriteToServer(dt);

                        //Actualizando campos 

                        string Sql = "UPDATE TEMPORAL_IMPORTACION_ASIGNACION SET nombreArchivo='" + nombreArchivo + "',  idUsuarioImportacion='" + usuario + "', fechaImportacion=getdate()   WHERE idUsuarioImportacion IS NULL    ";
                    ...
                    using (SqlCommand cmd = new SqlCommand("SP_S_TEMPORAL_IMPORTACION_ASIGNACION_AGRUPADO", con))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@idUsuario", SqlDbType.Int).Value = usuario;
        ...
        public object Capa_Dato_save_importacionAsignacion(int anio, int mes, int idCargo, int idEstado, int usuario)
        {
            Resultado res = new Resultado();
            try
            {
                using (SqlConnection con = new SqlConnection(cadenaCnx))
                {
                    ...
                    try
                    {
                        using (SqlCommand cmd = new SqlCommand("SP_I_ASIGNACION_LDS_IMPORTAR_EXCEL_GRABAR", con, sqlTran))
                        {
                            cmd.CommandTimeout = 0;
                            cmd.CommandType = CommandType.StoredProcedure;
                            cmd.Parameters.Add("@anio", SqlDbType.Int).Value = anio;
        ...
        public object Capa_Dato_getConsultaReparto(string anio, string mes, int idCargo, int idSucursal)
        {
            Resultado res = new Resultado();
            try
            {
                ...
                {
                    con.Open();
                    using (SqlCommand cmd = new SqlCommand("SP_S_REPORTE_CONSULTA_REPARTO_CAB", con))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@anio", SqlDbType.Int).Value = anio;
        ...
        public object Capa_Dato_getExportar_consultaReparto(string anio, string mes, int idCargo, int idSucursal)
        {
            Resultado res = new Resultado();
            try
            {
                using (SqlConnection con = new SqlConnection(cadenaCnx))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand("SP_S_REPORTE_CONSULTA_REPARTO_CAB", con))
                    {
                        ...
                        using (SqlDataAdapter da = new SqlDataAdapter(cmd))
                        {
                            ...
                            {
                                res.ok = true;
                                res.data = GenerarExcel_consultaReparto(dt_detalle);
                            }
                        }
                    }
                }
        ...
        public string GenerarExcel_consultaReparto(DataTable listDetalle)
        {
            string Res = "";
            string FileRuta = "";
            string FileExcel = "";
            ...
            try
            {
                var guid = Guid.NewGuid();
                var guidB = guid.ToString("B");
                var nombreFile = "ConsultaReparto_" + Guid.Parse(guidB) + ".xlsx";
                ...
                using (Excel.ExcelPackage oEx = new Excel.ExcelPackage(_file))
                {
                    Excel.ExcelWorksheet oWs = oEx.Workbook.Worksheets.Add("consultaReparto");
                    oWs.Cells.Style.Font.SetFromFont(new Font("Tahoma", 8));


                    oWs.Cells[_fila, pos].Value = "SUCURSAL"; pos += 1;
                    oWs.Cells[_fila, pos].Value = "ZONA"; pos += 1;
                    oWs.Cells[_fila, pos].Value = "REPARTIDOR"; pos += 1;
                    ...
                    oWs.Cells[_fila, pos].Value = "SUPERVISADO"; pos += 1;

                    oWs.Cells[_fila, pos].Value = "% SUPERVISADO"; pos += 1;
                    oWs.Cells[_fila, pos].Value = "INICO REPARTO"; pos += 1;
                    oWs.Cells[_fila, pos].Value = "FIN DE REPARTO"; pos += 1; 
                    oWs.Cells[_fila, pos].Value = "PLAZO"; pos += 1;
                    ...
                    foreach (DataRow item in listDetalle.Rows)
                    {
                        ...
                        oWs.Cells[_fila, pos].Value = item["recPorcentajeRep"].ToString(); pos += 1;
                        oWs.Cells[_fila, pos].Value = item["supervisor"].ToString(); pos += 1;
                        oWs.Cells[_fila, pos].Value = item["supervisado"].ToString(); pos += 1;

                        oWs.Cells[_fila, pos].Value = item["porcSupervisado"].ToString(); pos += 1;
                        oWs.Cells[_fila, pos].Value = item["inicioReparto"].ToString(); pos += 1;
                        oWs.Cells[_fila, pos].Value = item["finReparto"].ToString(); pos += 1;
                        oWs.Cells[_fila, pos].Value = item["plazo"].ToString(); pos += 1;
        ...
        public object Capa_Dato_setFinalizarReparto(int anio, int mes, int idCargo, int idSucursal, int idUsuario)
        {
            Resultado res = new Resultado();
            try
            {
                ...
                {
                    con.Open();
                    using (SqlCommand cmd = new SqlCommand("SP_S_REPORTE_CONSULTA_REPARTO_FINALIZAR", con))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@anio", SqlDbType.Int).Value = anio;
        ...
        public object Capa_Dato_getSuministrosAsignados(string anio, string mes, int idCargo, string idSucursal, string zona)
        {
            Resultado res = new Resultado();
            try
            {
                ...
                {
                    con.Open();
                    using (SqlCommand cmd = new SqlCommand("SP_S_REPORTE_CONSULTA_REPARTO_SUMINISTROS_ASIGNADO", con))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@anio", SqlDbType.Int).Value = anio;
        ...
        public object Capa_Dato_getReporteConsultaSuministro(string suministro)
        {
            Resultado res = new Resultado();
            List<ConsultaSuministro_E> obj_List = new List<ConsultaSuministro_E>();
            ...
            try
            {
                ...
                {
                    con.Open();
                    using (SqlCommand cmd = new SqlCommand("SP_S_REPORTE_CONSULTA_SUMINISTRO_CAB", con))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@suministro", SqlDbType.VarChar).Value = suministro;
                        ...
                        using (SqlDataReader dr = cmd.ExecuteReader())
                        {
                            while (dr.Read())
                            {
                                ConsultaSuministro_E Entidad = new ConsultaSuministro_E();

                                Entidad.id_Reparto = Convert.ToInt32(dr["id_Reparto"]);
                                Entidad.tipoServicio = dr["tipoServicio"].ToString();
                                Entidad.periodo = dr["periodo"].ToString();
                                Entidad.suministro = dr["suministro"].ToString();
                                Entidad.ruta = dr["ruta"].ToString();
                                ...
                                Entidad.fechaMaxReparto = dr["fechaMaxReparto"].ToString();
                                Entidad.fechaRecepcion = dr["fechaRecepcion"].ToString();
        ...
        public object Capa_Dato_getDescargar_reporteDetalladoReparto(string anio, string mes, int idCargo, int tipoReporte)
        {
            Resultado res = new Resultado();
            ...
            try
            {
                if (tipoReporte == 1)
                {
                    nombreProcedimiento = "SP_S_REPORTE_DETALLE_POR_LIBRO";
                }
                if (tipoReporte == 2)
                {
                    nombreProcedimiento = "SP_S_REPORTE_DETALLE_POR_SECTOR";
                }
                if (tipoReporte == 3)
                {
                    nombreProcedimiento = "SP_S_REPORTE_DETALLE_POR_SUCURSAL";
                }
                if (tipoReporte == 4)
                {
                    nombreProcedimiento = "SP_S_REPORTE_DETALLE_POR_REPARTIDOR";
                }
                    ...
                    using (SqlCommand cmd = new SqlCommand(nombreProcedimiento, con))
                    {
                        ...
                        using (SqlDataAdapter da = new SqlDataAdapter(cmd))
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    res.ok = true;
                                    res.data = GenerarExcel_detalleLibro(dt_detalle, FileRuta, FileExcel);
                                }
                                if (tipoReporte == 2)
                                {
                                    res.ok = true;
                                    res.data = GenerarExcel_detalleSector(dt_detalle, FileRuta, FileExcel);
                                }
                                if (tipoReporte == 3)
                                {
                                    res.ok = true;
                                    res.data = GenerarExcel_detalleSucursal(dt_detalle, FileRuta, FileExcel);
                                }
                                if (tipoReporte == 4)
                                {
                                    res.ok = true;
                                    res.data = GenerarExcel_detalleRepartidor(dt_detalle, FileRuta, FileExcel);
                                }
                            }
                        }
                    }
        ...
        public string GenerarExcel_detalleLibro(DataTable listDetalle, string FileRuta, string FileExcel)
        {
            string Res = "";
            int _fila = 1;
            int pos = 1;
            ...
            try
            {
                ...
                using (Excel.ExcelPackage oEx = new Excel.ExcelPackage(_file))
                {
                    Excel.ExcelWorksheet oWs = oEx.Workbook.Worksheets.Add("ReporteDetalladoLibro");
                    oWs.Cells.Style.Font.SetFromFont(new Font("Tahoma", 8));

                    oWs.Cells[_fila, pos].Value = "MES"; pos += 1;
                    oWs.Cells[_fila, pos].Value = "CARGO"; pos += 1;
                    oWs.Cells[_fila, pos].Value = "SUCURSAL"; pos += 1;
                    oWs.Cells[_fila, pos].Value = "LIBRO"; pos += 1;
                    oWs.Cells[_fila, pos].Value = "REPARTIDOR"; pos += 1;

                    oWs.Cells[_fila, pos].Value = "RECIBOS A ENTREGAR "; pos += 1;
                    oWs.Cells[_fila, pos].Value = "RECIBOS ENTREGADOS"; pos += 1;
                    oWs.Cells[_fila, pos].Value = "ENTREGA PENDIENTE"; pos += 1;

                    oWs.Cells[_fila, pos].Value = "FECHA DE RECEPCION"; pos += 1;
                    oWs.Cells[_fila, pos].Value = "FECHA INICIO"; pos += 1;
                    oWs.Cells[_fila, pos].Value = "FECHA DE CIERRE"; pos += 1;
        ...
        public string GenerarExcel_detalleSucursal(DataTable listDetalle, string FileRuta, string FileExcel)
        {
            string Res = "";
            int _fila = 1;
            int pos = 1;
            ...
            try
            {
                ...
                using (Excel.ExcelPackage oEx = new Excel.ExcelPackage(_file))
                {
                    ...
                    oWs.Cells[_fila, pos].Value = "SUCURSAL"; pos += 1;
                    oWs.Cells[_fila, pos].Value = "SECTOR"; pos += 1; 
                    oWs.Cells[_fila, pos].Value = "PENDIENTE"; pos += 1;
                    oWs.Cells[_fila, pos].Value = "ENTREGADOS"; pos += 1;
                    oWs.Cells[_fila, pos].Value = "PORCENTAJES"; pos += 1; 
        ...
        public string GenerarExcel_detalleRepartidor(DataTable listDetalle, string FileRuta, string FileExcel)
        {
            string Res = "";
            int _fila = 1;
            int pos = 1;
            ...
            try
            {
                ...
                using (Excel.ExcelPackage oEx = new Excel.ExcelPackage(_file))
                {
                    Excel.ExcelWorksheet oWs = oEx.Workbook.Worksheets.Add("ReporteDetalladoRepartidor");
                    oWs.Cells.Style.Font.SetFromFont(new Font("Tahoma", 8));

                    oWs.Cells[_fila, pos].Value = "OPERARIO"; pos += 1;
                    oWs.Cells[_fila, pos].Value = "PENDIENTE"; pos += 1;
                    oWs.Cells[_fila, pos].Value = "ENTREGADOS"; pos += 1;
                    oWs.Cells[_fila, pos].Value = "PORCENTAJES"; pos += 1;
        ...
        public string GenerarExcel_detalleSector(DataTable listDetalle, string FileRuta, string FileExcel)
        {
            string Res = "";
            int _fila = 1;
            int pos = 1;
            ...
            try
            {
                ...
                using (Excel.ExcelPackage oEx = new Excel.ExcelPackage(_file))
                {
                    Excel.ExcelWorksheet oWs = oEx.Workbook.Worksheets.Add("ReporteDetalladoSector");
                    oWs.Cells.Style.Font.SetFromFont(new Font("Tahoma", 8));
                    
                    oWs.Cells[_fila, 2, _fila, 4].Merge = true;  // combinar celdaS dt
                    oWs.Cells[_fila, 2].Value = "3100";
                    oWs.Cells[_fila, 2].Style.Font.Size = 15; //letra tamaño  
 
                    oWs.Cells[_fila, 5, _fila, 7].Merge = true;  // combinar celdaS dt
                    oWs.Cells[_fila, 5].Value = "3200";
                    oWs.Cells[_fila, 5].Style.Font.Size = 15; //letra tamaño  
 
                    oWs.Cells[_fila, 8, _fila, 10].Merge = true;  // combinar celdaS dt
                    oWs.Cells[_fila, 8].Value = "3300";
                    oWs.Cells[_fila, 8].Style.Font.Size = 15; //letra tamaño  

                    oWs.Cells[_fila, 11, _fila, 13].Merge = true;  // combinar celdaS dt
                    oWs.Cells[_fila, 11].Value = "4100";
                    oWs.Cells[_fila, 11].Style.Font.Size = 15; //letra tamaño  
 
                    oWs.Cells[_fila, 14, _fila, 16].Merge = true;  // combinar celdaS dt
                    oWs.Cells[_fila, 14].Value = "4200";
                    oWs.Cells[_fila, 14].Style.Font.Size = 15; //letra tamaño  
 
                    oWs.Cells[_fila, 17, _fila, 19].Merge = true;  // combinar celdaS dt
                    oWs.Cells[_fila, 17].Value = "4300";
                    oWs.Cells[_fila, 17].Style.Font.Size = 15; //letra tamaño  
 
                    oWs.Cells[_fila, 20, _fila, 22].Merge = true;  // combinar celdaS dt
                    oWs.Cells[_fila, 20].Value = "4400";
                    oWs.Cells[_fila, 20].Style.Font.Size = 15; //letra tamaño  
 
                    oWs.Cells[_fila, 23, _fila, 25].Merge = true;  // combinar celdaS dt
                    oWs.Cells[_fila, 23].Value = "5100";
                    oWs.Cells[_fila, 23].Style.Font.Size = 15; //letra tamaño  
 
                    oWs.Cells[_fila, 26, _fila, 28].Merge = true;  // combinar celdaS dt
                    oWs.Cells[_fila, 26].Value = "5200";
                    oWs.Cells[_fila, 26].Style.Font.Size = 15; //letra tamaño  
                    ...
                    oWs.Cells[_fila, pos].Value = "PENDIENTE"; pos += 1;
                    oWs.Cells[_fila, pos].Value = "ENTREGADO"; pos += 1;
                    oWs.Cells[_fila, pos].Value = "% AVANCE"; pos += 1;
                    ...
                    foreach (DataRow item in listDetalle.Rows)
                    {
                        ...
                        oWs.Cells[_fila, pos].Value = item["sector"].ToString(); pos += 1;
                        oWs.Cells[_fila, pos].Value = item["pendientes_3100"].ToString(); pos += 1;
                        oWs.Cells[_fila, pos].Value = item["entregados_3100"].ToString(); pos += 1;
                        oWs.Cells[_fila, pos].Value = item["porcentaje_3100"].ToString(); pos += 1;

                        oWs.Cells[_fila, pos].Value = item["pendientes_3200"].ToString(); pos += 1;
                        oWs.Cells[_fila, pos].Value = item["entregados_3200"].ToString(); pos += 1;
                        oWs.Cells[_fila, pos].Value = item["porcentaje_3200"].ToString(); pos += 1;

                        oWs.Cells[_fila, pos].Value = item["pendientes_3300"].ToString(); pos += 1;
                        oWs.Cells[_fila, pos].Value = item["entregados_3300"].ToString(); pos += 1;
                        oWs.Cells[_fila, pos].Value = item["porcentaje_3300"].ToString(); pos += 1;

                        oWs.Cells[_fila, pos].Value = item["pendientes_4100"].ToString(); pos += 1;
                        oWs.Cells[_fila, pos].Value = item["entregados_4100"].ToString(); pos += 1;
                        oWs.Cells[_fila, pos].Value = item["porcentaje_4100"].ToString(); pos += 1;

                        oWs.Cells[_fila, pos].Value = item["pendientes_4200"].ToString(); pos += 1;
                        oWs.Cells[_fila, pos].Value = item["entregados_4200"].ToString(); pos += 1;
                        oWs.Cells[_fila, pos].Value = item["porcentaje_4200"].ToString(); pos += 1;

                        oWs.Cells[_fila, pos].Value = item["pendientes_4300"].ToString(); pos += 1;
                        oWs.Cells[_fila, pos].Value = item["entregados_4300"].ToString(); pos += 1;
                        oWs.Cells[_fila, pos].Value = item["porcentaje_4300"].ToString(); pos += 1;

                        oWs.Cells[_fila, pos].Value = item["pendientes_4400"].ToString(); pos += 1;
                        oWs.Cells[_fila, pos].Value = item["entregados_4400"].ToString(); pos += 1;
                        oWs.Cells[_fila, pos].Value = item["porcentaje_4400"].ToString(); pos += 1;

                        oWs.Cells[_fila, pos].Value = item["pendientes_5100"].ToString(); pos += 1;
                        oWs.Cells[_fila, pos].Value = item["entregados_5100"].ToString(); pos += 1;
                        oWs.Cells[_fila, pos].Value = item["porcentaje_5100"].ToString(); pos += 1;

                        oWs.Cells[_fila, pos].Value = item["pendientes_5200"].ToString(); pos += 1;
                        oWs.Cells[_fila, pos].Value = item["entregados_5200"].ToString(); pos += 1;
                        oWs.Cells[_fila, pos].Value = item["porcentaje_5200"].ToString(); pos += 1;
