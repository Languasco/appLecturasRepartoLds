...
namespace DSIGE.Negocio
{
    public class Cls_Negocio_Importacion_Lecturas
    {
       ...
       public object Capa_Negocio_generarRepartoPDf(string fechaAsignacion, int tipo, string tipoCargo)
        ...
        public object Capa_Negocio_save_CargaProgramacion(string fechaEnvioMovil, int idServicio, int idOpcion, int usuario)
        {
            try
            {
                Cls_Dato_Importacion_Lecturas Objeto_Dato = new Cls_Dato_Importacion_Lecturas();
                return Objeto_Dato.Capa_Dato_save_CargaProgramacion(fechaEnvioMovil, idServicio, idOpcion, usuario);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public object Capa_Negocio_save_MacroOrdenes(string fechaEnvioMovil, int idServicio, int idOpcion, int usuario)
        {
            try
            {
                Cls_Dato_Importacion_Lecturas Objeto_Dato = new Cls_Dato_Importacion_Lecturas();
                return Objeto_Dato.Capa_Dato_save_MacroOrdenes(fechaEnvioMovil, idServicio, idOpcion, usuario);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public object Capa_Negocio_save_MacroOperaciones(string fechaEnvioMovil, int idServicio, int idOpcion, int usuario)
        {
            try
            {
                Cls_Dato_Importacion_Lecturas Objeto_Dato = new Cls_Dato_Importacion_Lecturas();
                return Objeto_Dato.Capa_Dato_save_MacroOperaciones(fechaEnvioMovil, idServicio, idOpcion, usuario);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public object Capa_Negocio_save_temporalImportarLds(string fileLocation, int usuario ,string nombreArchivo )
        {
            try
            {
                Cls_Dato_Importacion_Lecturas Objeto_Dato = new Cls_Dato_Importacion_Lecturas();
                return Objeto_Dato.Capa_Dato_save_temporalImportarLds(fileLocation, usuario, nombreArchivo);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public object Capa_Negocio_save_importacionLds(string fechaRecepcion, string fechaInicio, string fechaTermino, int usuario, int tipoReparto, int anio, int mes)
        {
            try
            {
                Cls_Dato_Importacion_Lecturas Objeto_Dato = new Cls_Dato_Importacion_Lecturas();
                return Objeto_Dato.Capa_Dato_save_importacionLds(fechaRecepcion, fechaInicio, fechaTermino, usuario, tipoReparto, anio ,mes);
            }
            catch (Exception e)
            {
                throw e;
