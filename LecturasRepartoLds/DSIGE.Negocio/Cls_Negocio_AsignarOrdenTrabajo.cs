...
namespace DSIGE.Negocio
{
    public class Cls_Negocio_AsignarOrdenTrabajo
    {
       ...
       public string Capa_Negocio_set_anulando_unidad_lectura(string Cod_UnidadLectura,  int id_usuario)
        ...
        public object Capa_Negocio_getCargos()
        {
            try
            {
                Cls_Dato_AsignaOrdenTrabajo Objeto_Dato = new Cls_Dato_AsignaOrdenTrabajo();
                return Objeto_Dato.Capa_Dato_getCargos();
            }
            catch (Exception e)
            {
                throw e;
        ...
        public object Capa_Negocio_getEstados()
        {
            try
            {
                Cls_Dato_AsignaOrdenTrabajo Objeto_Dato = new Cls_Dato_AsignaOrdenTrabajo();
                return Objeto_Dato.Capa_Dato_getEstados();
            }
            catch (Exception e)
            {
                throw e;
        ...
        public object Capa_Negocio_getSucursales()
        {
            try
            {
                Cls_Dato_AsignaOrdenTrabajo Objeto_Dato = new Cls_Dato_AsignaOrdenTrabajo();
                return Objeto_Dato.Capa_Dato_getSucursales();
            }
            catch (Exception e)
            {
                throw e;
        ...
        public object Capa_Negocio_getOperarios()
        {
            try
            {
                Cls_Dato_AsignaOrdenTrabajo Objeto_Dato = new Cls_Dato_AsignaOrdenTrabajo();
                return Objeto_Dato.Capa_Dato_getOperarios();
            }
            catch (Exception e)
            {
                throw e;
        ...
        public object Capa_Negocio_getSupervisores()
        {
            try
            {
                Cls_Dato_AsignaOrdenTrabajo Objeto_Dato = new Cls_Dato_AsignaOrdenTrabajo();
                return Objeto_Dato.Capa_Dato_getSupervisores();
            }
            catch (Exception e)
            {
                throw e;
        ...
        public object Capa_Negocio_getRepartos_asignarReasignar(string anio, string mes, int idCargo, int idEstado)
        {
            try
            {
                Cls_Dato_AsignaOrdenTrabajo Objeto_Dato = new Cls_Dato_AsignaOrdenTrabajo();
                return Objeto_Dato.Capa_Dato_getRepartos_asignarReasignar(anio, mes, idCargo, idEstado);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public object Capa_Negocio_GenerarAsignacionReasignacion(List<Asignar_E> ListaOrdenes, int anio, int mes, int idCargo, int idEstado, string tipo, int usuario, int idTecnico)
        {
            try
            {
                Cls_Dato_AsignaOrdenTrabajo Objeto_Dato = new Cls_Dato_AsignaOrdenTrabajo();
                return Objeto_Dato.Capa_Dato_GenerarAsignacionReasignacion(ListaOrdenes, anio, mes, idCargo, idEstado, tipo, usuario, idTecnico);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public object Capa_Negocio_getExportar_Asignacion(string anio, string mes, int idCargo, int idEstado)
        {
            try
            {
                Cls_Dato_AsignaOrdenTrabajo Objeto_Dato = new Cls_Dato_AsignaOrdenTrabajo();
                return Objeto_Dato.Capa_Dato_getExportar_Asignacion(anio, mes, idCargo, idEstado);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public object Capa_Negocio_save_temporalImportarAsignacion(string fileLocation, int usuario, string nombreArchivo, int anio, int mes, int idCargo, int idEstado)
        {
            try
            {
                Cls_Dato_AsignaOrdenTrabajo Objeto_Dato = new Cls_Dato_AsignaOrdenTrabajo();
                return Objeto_Dato.Capa_Dato_save_temporalImportarAsignacion(fileLocation, usuario, nombreArchivo, anio, mes, idCargo, idEstado);
            }
            catch (Exception e)
            {
                throw e;
                ...
                public object Capa_Negocio_save_importacionAsignacion(int anio, int mes, int idCargo, int idEstado , int usuario)
        {
            try
            {
                Cls_Dato_AsignaOrdenTrabajo Objeto_Dato = new Cls_Dato_AsignaOrdenTrabajo();
                return Objeto_Dato.Capa_Dato_save_importacionAsignacion( anio, mes, idCargo, idEstado, usuario);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public object Capa_Negocio_getConsultaReparto(string anio, string mes, int idCargo, int idSucursal)
        {
            try
            {
                Cls_Dato_AsignaOrdenTrabajo Objeto_Dato = new Cls_Dato_AsignaOrdenTrabajo();
                return Objeto_Dato.Capa_Dato_getConsultaReparto(anio, mes, idCargo, idSucursal);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public object Capa_Negocio_getExportar_consultaReparto(string anio, string mes, int idCargo, int idSucursal)
        {
            try
            {
                Cls_Dato_AsignaOrdenTrabajo Objeto_Dato = new Cls_Dato_AsignaOrdenTrabajo();
                return Objeto_Dato.Capa_Dato_getExportar_consultaReparto(anio, mes, idCargo, idSucursal);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public object Capa_Negocio_setFinalizarReparto(int anio, int mes, int idCargo, int idSucursal, int idUsuario )
        {
            try
            {
                Cls_Dato_AsignaOrdenTrabajo Objeto_Dato = new Cls_Dato_AsignaOrdenTrabajo();
                return Objeto_Dato.Capa_Dato_setFinalizarReparto(anio, mes, idCargo, idSucursal, idUsuario);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public object Capa_Negocio_getSuministrosAsignados(string anio, string mes, int idCargo, string idSucursal, string zona)
        {
            try
            {
                Cls_Dato_AsignaOrdenTrabajo Objeto_Dato = new Cls_Dato_AsignaOrdenTrabajo();
                return Objeto_Dato.Capa_Dato_getSuministrosAsignados(anio, mes, idCargo, idSucursal, zona);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public object Capa_Negocio_getReporteConsultaSuministro(string suministro)
        {
            try
            {
                Cls_Dato_AsignaOrdenTrabajo Objeto_Dato = new Cls_Dato_AsignaOrdenTrabajo();
                return Objeto_Dato.Capa_Dato_getReporteConsultaSuministro(suministro);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public object Capa_Negocio_getDescargar_reporteDetalladoReparto(string anio, string mes, int idCargo, int tipoReporte)
        {
            try
            {
                Cls_Dato_AsignaOrdenTrabajo Objeto_Dato = new Cls_Dato_AsignaOrdenTrabajo();
                return Objeto_Dato.Capa_Dato_getDescargar_reporteDetalladoReparto(anio, mes, idCargo, tipoReporte);
            }
            catch (Exception e)
            {
                throw e;
